 ...
 * назва пропорції, має співпадати з назвами пропорцій у файлі assets/tvs/multitv/configs/goods_images
 * якщо не співпадає, то img1x1 в value не буде замінено на парамтери пропорції
 * 'ratio' => 'img1x1',
 ...
 * q якість стиснення
 * far=TL,iar=1 параметри обробника phpThumb
