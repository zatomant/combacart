...
/**
 * return primary key, or part of the array by primary key, or value by key of part of the array by primary key
 *
 * @return bool|string|array
 */
//function recursive_array_search_key_value(array $array, string $searchValue, string $searchKey = 'name', bool $returnArray = false, string $returnKeyValue = null)
//{
//    foreach ($array as $key => $value) {
//        if (isset($value[$searchKey]) && $value[$searchKey] === $searchValue) {
//            if ($returnArray) {
//                if ($returnKeyValue !== null) {
//                    return $value[$returnKeyValue] ?? false;
//                }
//                return $value;
//            } else {
//                if ($returnKeyValue !== null) {
