...
class ModxOperCart extends ModxOper
{
    ...
    public function render()
    {
        ...
        if (!empty($doc)) {// && $doc['doc_status'] != 4) {
            ...
            if (!empty($doc['specs'])) {
                ...
                foreach ($doc['specs'] as &$row) {
                    ...
                    if (defined('COMBAMODX_SELLER_SHOW') && COMBAMODX_SELLER_SHOW) {
        ...
        if (defined('COMBAMODX_ORDER_SEPARATE_BY_SELLERS') && COMBAMODX_ORDER_SEPARATE_BY_SELLERS) {
        ...
        $_recaptcha = get3thAuth('reCaptcha');
