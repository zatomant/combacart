 ...
 * індивідуальні налаштування локального маркетплейсу зберігайте в лише файлі /assets/custom/Config/marketplace.php
 *
 */
...
return [
    'Marketplace' => [
        ...
        'contact' => [
            ...
            ['type' => 'email', 'label' => 'sales@' . COMBAMODX_SERVER_NAME, 'number' => 'sales@' . COMBAMODX_SERVER_NAME, 'i1nvisible' => true],
        ],
        'sellers' => [
