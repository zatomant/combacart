...
class CC_FormatTwig extends AbstractExtension
{
   ...
   /ux',
    ...
    function formatTranslit($string)
    {
    ...
    function formatName($str, $delim = ' ', $limit = 2)
    {
        $out = '';
        $str = rtrim(ltrim($str));
    ...
    function formatDeclaration($str, $raw = 0)
    {
        $out = '';
        if ($raw != 0) return $str;
