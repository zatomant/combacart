...
За замовчуванням для підтримки багатомовності на сайті та в панелі керування замовленнями використовується вбудований "перекладач", що використовує клас Options. 
Метод Options::detectLanguage() визначає поточну мову та керує завантаженням перекладів.
Для прикладу файл що містить переклад на українську мову /assets/lang/uk.php
