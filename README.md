...
6) Створіть сторінку з псевдонімом (alias) cabinet та задайте їй вміст ресурсу [[CombaHelper? &action=`cabinet`]]. Це буде сторінка з історіює замовленнь покупця.
...
без необхідності авторизації в адмінці evo modx.
