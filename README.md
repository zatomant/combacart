...
через інтерфейс користувача на сервері ви можете відправляти запити на активацію/деактивацію Товарів, оновлювати зображення Товару без необхідності авторизації в адмінці evo modx.
